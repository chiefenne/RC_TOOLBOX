...
while IFS= read -r line || [[ -n "$line" ]]; do
    ...
    for SIZE in $SIZES; do
        ...
        npx github:lvgl/lv_font_conv \
            ...
            --font "$FONT_FILE" \
            --format lvgl \
            --range 0x20-0x7F,0xC0,0xC1,0xC2,0xC3,0xC4,0xC7,0xC8,0xC9,0xCA,0xCB,0xCC,0xCD,0xCE,0xCF,0xD1,0xD2,0xD3,0xD4,0xD5,0xD6,0xD8,0xD9,0xDA,0xDB,0xDC,0xDD,0xDF,0xE0,0xE1,0xE2,0xE3,0xE4,0xE7,0xE8,0xE9,0xEA,0xEB,0xEC,0xED,0xEE,0xEF,0xF1,0xF2,0xF3,0xF4,0xF5,0xF6,0xF8,0xF9,0xFA,0xFB,0xFC,0xFD,0xFF,0xB5,0x3BC,0xA9,0x3C,0x3E,0x25BA,0x25C4,0x25B2,0x25BC,0x10C,0x10D,0x10E,0x10F,0x11A,0x11B,0x147,0x148,0x158,0x159,0x160,0x161,0x16E,0x16F,0x17D,0x17E \
            --output "$OUTPUT"
    done
