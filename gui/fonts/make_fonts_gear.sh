...
while IFS= read -r line || [[ -n "$line" ]]; do
    ...
    for SIZE in $SIZES; do
        ...
        # HEX codes for following symbols are used in range
        # copyright, right triangle, left triangle, gear, plane, left arrow, right arrow, Austrian flag letters A and T (0x1F1E6 0x1F1F9)
